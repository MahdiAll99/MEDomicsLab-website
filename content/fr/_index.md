    ...
    content:
      text: |
        <div style="text-align: center; margin: 1rem 0;">
          ...
          <label style="color: #bd0606; font-size: 0.9rem;">Notez que le processus d'installation sous macOS comporte deux étapes : exécutez d'abord le fichier .pkg, puis le fichier .dmg.</label>
        </div>
        <div class="download-section" style="display: flex; justify-content: space-between; gap: 2rem; margin: 0rem 0;">
          ...
          <div style="flex: 1; text-align: center; border: 1px solid #e0e0e0; border-radius: 10px; padding: 1.5rem;">
            ...
            <select id="windows-version" style="margin: 0.5rem 0; padding: 0.5rem; border: 1px solid #ccc; border-radius: 5px;">
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-win.exe">Version 1.8.1 (dernière)</option>
            ...
            <a id="windows-download" href="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-win.exe" 
          ...
          <div style="flex: 1; text-align: center; border: 1px solid #e0e0e0; border-radius: 10px; padding: 1.5rem;">
            ...
            <select id="linux-version" style="margin: 0.5rem 0; padding: 0.5rem; border: 1px solid #ccc; border-radius: 5px;">
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-ubuntu.deb">Version 1.8.1 (dernière)</option>
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.0/MEDomics-1.8.0-ubuntu.deb">Version 1.8.0</option>
            ...
            <a id="linux-download" href="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-ubuntu.deb" 
              style="display: inline-block; margin-top: 1rem; padding: 0.75rem 1.5rem; background-color: #007bff; color: white; border-radius: 5px; text-decoration: none;">
              Télécharger
            </a>
          </div>
          ...
          <div style="flex: 1; text-align: center; border: 1px solid #e0e0e0; border-radius: 10px; padding: 1.5rem;">
            ...
            <h3>Mac (PKG)</h3>
            <label style="color: #666; font-size: 0.9rem;">Doit être installé en premier avant le DMG</label>
            <select id="mac-version" style="margin: 0.5rem 0; padding: 0.5rem; border: 1px solid #ccc; border-radius: 5px;">
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-mac.pkg">Version 1.8.1 (dernière)</option>
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.0/MEDomics-1.8.0-mac.pkg">Version 1.8.0</option>
            ...
            <a id="mac-download" href="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-mac.pkg" 
              style="display: inline-block; margin-top: 1rem; padding: 0.75rem 1.5rem; background-color: #007bff; color: white; border-radius: 5px; text-decoration: none;">
              Télécharger
            </a>
          </div>
          ...
          <div style="flex: 1; text-align: center; border: 1px solid #e0e0e0; border-radius: 10px; padding: 1.5rem;">
            <img src="https://img.icons8.com/?size=512&id=122959&format=png" alt="Mac Logo" style="width: 200px; height:200px; margin-bottom: 1rem;">
            <h3>Mac (DMG)</h3>
            <label style="color: #666; font-size: 0.9rem;">Doit être installé en deuxième après le PKG</label>
            <select id="mac-version" style="margin: 0.5rem 0; padding: 0.5rem; border: 1px solid #ccc; border-radius: 5px;">
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.1/MEDomics-1.8.1-mac.dmg">Version 1.8.1 (dernière)</option>
              <option value="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.0/MEDomics-1.8.0-mac.dmg">Version 1.8.0</option>
            ...
            <a id="mac-download" href="https://github.com/MEDomicsLab/MEDomics/releases/download/v1.8.0/MEDomics-1.8.0-mac.dmg"
              style="display: inline-block; margin-top: 1rem; padding: 0.75rem 1.5rem; background-color: #007bff; color: white; border-radius: 5px; text-decoration: none;">
              Télécharger
            </a>
          </div>
